...
class UserInput(BaseModel):
    ...
    user_info: dict[str, Any] = Field(
        description="User information to be passed to the agent.",
        default={},
    )
    selected_databases: list[dict] = Field(
        description="List of selected databases to be passed to the agent.",
        default=[],
    )
